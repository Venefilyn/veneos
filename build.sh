...
flatpak install --system --reinstall -y flathub runtime/org.fedoraproject.Platform/x86_64/${RELEASE}
flatpak install --system --reinstall -y fedora app/org.mozilla.firefox/x86_64/stable 
